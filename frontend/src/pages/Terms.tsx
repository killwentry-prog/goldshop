...
const sections = [
  {
    ...
    text: 'Минимальная сумма заказа составляет 500 Gold. Заказы на меньшее количество не принимаются.',
  },
  {
    title: 'Порядок покупки',
    text: 'Укажите количество Gold, оплатите заказ, выставите указанный предмет на торговой площадке Standoff 2 и приложите скриншот. Менеджер проверит заявку и завершит сделку.',
  },
  {
    title: 'Возвраты',
  ...
  {
    title: 'Правила',
    text: 'Указывайте достоверные данные и загружайте реальный скриншот выставленного предмета. Попытки мошенничества приводят к отклонению заказа.',
  },
];
      ...
      <div className="space-y-3 px-5">
        {sections.map((s, i) => (
          <GlassCard key={s.title} delay={i * 0.05} className="p-5">
            <p className="text-sm font-semibold text-gold-300">{s.title}</p>
